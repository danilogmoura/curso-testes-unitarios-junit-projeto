...
public class CadastroEditorTest {
    ...
    class CadastroComEditorValido {
        ...
        void beforeEach() {
            Mockito.when(armazenamentoEditor.salvar(Mockito.any(Editor.class)))
                    .thenAnswer(invocacao -> {
                        var editorPassado = invocacao.getArgument(0, Editor.class);
        ...
        void Dado_um_editor_valido_Quando_criar_Entao_deve_chamar_metodo_salvar_do_armazenamento() {
            ...
            Mockito.verify(armazenamentoEditor, Mockito.timeout(1))
        ...
        void Dado_um_editor_valido_Quando_cadastrar_Entao_deve_enviar_email_com_destino_ao_editor() {
            ...
            var mensagem = mensagemArgumentCaptor.getValue();

            assertEquals(editorSalvo.getEmail(), mensagem.getDestinatario());
        }

        @Test
        void Dado_um_editor_Quando_cadastrar_Entao_deve_verificar_o_email() {
            cadastroEditor.criar(editor);
        ...
        void Dado_um_editor_com_email_existente_Quando_cadastrar_Entao_deve_lancar_exception() {
            ...
            cadastroEditor.criar(editor);
            Editor editorExistente = new Editor(null, "Alex", "alex@email.com", BigDecimal.TEN, true);
            assertThrows(RegraNegocioException.class, () -> cadastroEditor.criar(editorExistente));
        }
    ...
    class EdicaoComEditorValido {
        ...
        void Dado_um_editor_valido_Quando_editar_Entao_deve_alterar_editor_salvo() {
            Editor editorAtualizado = new Editor(1L, "Alex Silva", "alex.silva@email.com", BigDecimal.TEN, true);

            cadastroEditor.editar(editorAtualizado);
            Mockito.verify(editor, Mockito.times(1)).atualizarComDados(editorAtualizado);

            var inOrder = Mockito.inOrder(editor, armazenamentoEditor);
    ...
    class EdicaoComEditorInexistente {
        ...
        @Test
        void Dado_um_editor_que_nao_exita_Quando_editar_Entao_deve_lancar_exception() {
